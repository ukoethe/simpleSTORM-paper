...
\begin{figure*}
\begin{centering}
\includegraphics[width=0.3\textwidth]{figures/betatub1_rs_maxprojection-2.png}$\qquad$\includegraphics[width=0.3\textwidth]{figures/betatub1_rs_std_driftCorrected_combinedImg.pdf}$\qquad$\includegraphics[width=0.3\textwidth]{figures/betatub1_rs_std_driftCorrected_combinedImg_cropped.png}
\par\end{centering}

\caption{Beta-tubulin labeled with AlexaFluor647 in a Hela cell.
Left: mean image of the raw data (data courtesy of M. Heilemann). Middle: reconstruction by SimpleSTORM. Right: magnification of the indicated subregion.}\label{fig:hela2-tubulin}
\end{figure*}
\begin{figure*}
\begin{centering}
