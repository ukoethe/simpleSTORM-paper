...
\begin{figure*}
\begin{centering}
\includegraphics[width=0.3\textwidth]{figures/Tubulin1_zproj.png}$\qquad$\includegraphics[width=0.3\textwidth]{figures/Tubulin1_reconstructed_rect2.png}$\qquad$\includegraphics[width=0.3\textwidth]{figures/Tubulin1_ausschnitt2.png}
\par\end{centering}

\caption{Tubulin 1 dataset from the ISBI Localization Microscopy Challenge. Left: mean projection of the raw data. Middle: reconstructed image. Right: localizations (green) and groundtruth (red).}
\end{figure*}
...
image. Right: magnified, selected part from the reconstructed image.h}
\end{figure*}
