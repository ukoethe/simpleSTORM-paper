...
\begin{figure}
\subfloat[Long sequence data set, true sigma is 0.8]{\includegraphics[width = 0.24\textwidth]{figures/SigmaBundledTubes1.png}}\hfill%
\subfloat[Long sequence data set, true sigma is 0.8]{\includegraphics[width = 0.24\textwidth]{figures/SigmaBundledTubes2.png}}\hfill%
\subfloat[Tubulin 1 data set, true sigma is 1.08]{\includegraphics[width = 0.24\textwidth]{figures/SigmaTubulin1.png}}\hfill%
\subfloat[Tubulin 2 data set, true sigma is 1.08]{\includegraphics[width = 0.24\textwidth]{figures/SigmaTubulin2.png}}
