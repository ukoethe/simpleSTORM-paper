...
&Jaccard&Precision&RMSE&time in sec.\\ \hline
...
\begin{figure*}
\begin{centering}
\includegraphics[width=0.3\textwidth]{figures/Tubulin1_zproj.png}$\qquad$\includegraphics[width=0.3\textwidth]{figures/Tubulin1_reconstructed_rect.png}$\qquad$\includegraphics[width=0.3\textwidth]{figures/Tubulin1_ausschnitt.png}
\par\end{centering}

\caption{Tubulin 1 dataset from the ISBI Localization Microscopy Challenge. Image on the left shows mean projection of the raw data, the other images show the reconstruction.}
\end{figure*}


\begin{figure*}
\begin{centering}
\includegraphics[width=0.45\textwidth]{figures/AVG_Hela2_aTub647-i.png}$\qquad$\includegraphics[width=0.45\textwidth]{figures/HeLa2_aTub647-i_resultHighContrast-1_reconstructed.png}
\par\end{centering}
