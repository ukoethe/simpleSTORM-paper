...
\begin{figure*}
\includegraphics[width=0.3\textwidth]{figures/Tubulin2OrigFrame50}$\qquad$\includegraphics[width=0.3\textwidth]{figures/dcframe4.png}$\qquad$\includegraphics[width=0.3\textwidth]{figures/Hela1_pfa_tub647_654_frame_3_raw_croped.png}
\includegraphics[width=0.3\textwidth]{figures/Tubulin2normalprocessFrame50}$\qquad$\includegraphics[width=0.3\textwidth]{figures/dcframe4_bgsubtracted.png}$\qquad$\includegraphics[width=0.3\textwidth]{figures/Hela1_pfa_tub647_654_frame_3_bgsubtracted_croped.png}
...
Experiments reported in section ??? validate our claim that the false
...
\caption{Tubulin 1 dataset from the ISBI Localization Microscopy Challenge.}
\end{figure*}
