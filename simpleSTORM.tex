...
open-source software. We will briefly review existing algorithms in section \ref{sec:related-work}.

While many of these algorithms are in principle able to obtain good
reconstructions, their practical success requires a careful adjustment of
...
popular rapidSTORM software \cite{wolter_10_rapid-storm}, the ImageJ plugins Octane \cite{yu_11_octane}, PeakFit \cite{herbert_12_peakfit} and GraspJ (offering GPU accelaration) \cite{brede_12_graspj}, as well as the Localization Microscopy MicroManager plugin \cite{stuurman_12_plugin} and PYME (the Python localization microscopy environment) \cite{baddeley_12_pyme}.
